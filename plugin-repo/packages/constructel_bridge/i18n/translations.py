...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "init.cadastre_header": "Cadastral data (UrbIS WFS)",
        "init.wfs_parcels": "Cadastral parcels",
        "init.wfs_buildings": "Buildings",
    ...
    "fr": {
        ...
        "init.cadastre_header": "Donnees cadastrales (UrbIS WFS)",
        "init.wfs_parcels": "Parcelles cadastrales",
        "init.wfs_buildings": "Batiments",
    ...
    "pt": {
        ...
        "init.cadastre_header": "Dados cadastrais (UrbIS WFS)",
        "init.wfs_parcels": "Parcelas cadastrais",
        "init.wfs_buildings": "Edificios",
